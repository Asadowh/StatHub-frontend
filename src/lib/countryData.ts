...
export const countryDatabase: CountryData[] = [
  ...
  { name: "United States", code: "US", flag: "🇺🇸", colors: ["#B22234", "#FFFFFF", "#3C3B6E"] },
  ...
  { name: "France", code: "FR", flag: "🇫🇷", colors: ["#002395", "#FFFFFF", "#ED2939"] },
  { name: "England", code: "GB", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", colors: ["#FFFFFF", "#CE1124"] },
  { name: "Italy", code: "IT", flag: "🇮🇹", colors: ["#009246", "#FFFFFF", "#CE2B37"] },
  { name: "Netherlands", code: "NL", flag: "🇳🇱", colors: ["#AE1C28", "#FFFFFF", "#21468B"] },
  { name: "Colombia", code: "CO", flag: "🇨🇴", colors: ["#FCD116", "#003893", "#CE1126"] },
  { name: "Mexico", code: "MX", flag: "🇲🇽", colors: ["#006847", "#FFFFFF", "#CE1126"] },
  { name: "Japan", code: "JP", flag: "🇯🇵", colors: ["#FFFFFF", "#BC002D"] },
  { name: "South Korea", code: "KR", flag: "🇰🇷", colors: ["#FFFFFF", "#C60C30", "#003478"] },
  { name: "Belgium", code: "BE", flag: "🇧🇪", colors: ["#000000", "#FDDA24", "#EF3340"] },
  { name: "Croatia", code: "HR", flag: "🇭🇷", colors: ["#FF0000", "#FFFFFF", "#171796"] },
